...
L["Color of the actionbutton when out of power (Mana, Rage)."] = "能量（法力值）不足，超出距离时动作条按键的颜色"
...
L["Enable/Disable the minimap. |cffFF0000Warning: This will prevent you from seeing the consolidated buffs bar, and prevent you from seeing the minimap datatexts.|r"] = "启用/禁用小地图。|cffFF0000警告：此选项会影响你看小地图旁增益提示条，也会影响你观察小地图上文本。|r"
...
L["X-Offset"] = "X轴偏移"
L["Y-Offset"] = "Y轴偏移"
L["You do not need to use 'Is Casting Anything' or 'Is Channeling Anything' for these spells to trigger."] = "你无需为此法术设置“释放法术”、“引导法术”选项。"
