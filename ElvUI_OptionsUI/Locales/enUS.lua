...
L["Shows item level of each item, sockets, and gems on the character page."] = true
L["Shows item level of each item, sockets, and gems when inspecting another player."] = true
L["Side Arrows"] = true
