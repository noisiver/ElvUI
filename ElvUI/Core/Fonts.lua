...
function E:UpdateBlizzardFonts()
	...
	if db.replaceNameplateFont then NAMEPLATE_FONT = NAMEFONT end
	if db.replaceCombatText then -- Blizzard_CombatText
		E:SetFont(CombatTextFont, COMBAT, 120, nil, nil, nil, nil, nil, 1, -1)
	end
	...
	if db.replaceBlizzFonts then
		...
		E:SetFont(_G.QuestTitleFont,						NORMAL, size + 8)
