...
local function OnEnter()
	...
	DT.tooltip:AddDoubleLine(L["PVP Item Level"], format("%0.2f", avgPvp), 1, 1, 1, colorize(avgPvp - avg))
	DT.tooltip:AddLine(" ")
...
DT:RegisterDatatext(L["Item Level"], L["Stats"], {"PLAYER_AVG_ITEM_LEVEL_UPDATE"}, OnEvent, nil, nil, OnEnter, nil, L["Item Level"], nil, ApplySettings)
